...
| Unit tests | Passed | 42 tests passed, including 12 detector-core tests, v1/v2-to-v3 migration, four notification display modes, disconnected-display fallback, multi-display rendering, permission/scheduling, Accessibility gating, and configured-effect routing. |
